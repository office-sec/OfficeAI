...
<img alt="WordAI主界面" src="wordai.png" title="WordAI主界面"/>
...
<img alt="插入符号" height="300" src="insert_symbol.png" title="插入符号"/>
...
<img alt="ExcelAI" height="300" src="excelai.gif" title="ExcelAI"/>
...
```
<img alt="Unique" height="300" src="unique.png" title="提取不重复的数据"/>
...
<img alt="快速格式化" height="300" src="toolbar.png" title="将数据格式化为常见格式"/>
